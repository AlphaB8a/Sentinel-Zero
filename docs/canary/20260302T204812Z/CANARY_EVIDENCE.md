...
- Zero-residue policy contract: [ZERO_RESIDUE_POLICY_CONTRACT_v1.md](../ZERO_RESIDUE_POLICY_CONTRACT_v1.md)
- Receipt tool: `scripts/security/assert_zero_residue.sh`
